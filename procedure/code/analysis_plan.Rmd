...
packages <- c("tidyverse", "here", "markdown", "htmltools", "dplyr", "sf", "stars", "tigris", "tmap")
...
#### Step 3: Group by carceral facility type and year *begin here to avoid running first two chunks!*
...
#### Step 4e: Calculate number of days per year above or equal to 26C, 28C, 39C, 35C

```{r}
# Load county-level data
dat.wbgt = readRDS(here("data", "derived", "private", 'weighted_area_raster_state_wbgtmax_daily_1982_2020.rds'))
...
# Calculate days at different temperatures
