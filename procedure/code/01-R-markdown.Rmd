...
The original study data transformations and analysis were completed primarily in R using Rmd documents, as well as python. The versions of R and Python used are not disclosed, but would have been R 4.3.3 or earlier, and Python 3.12 or earlier.
...
(When implimenting plan) Explain what we believe the authors did to produce the WBGTmax grid and preliminary steps
...
### Deviation 2: Investigating sources of uncertainy/error/bias
...
Discuss research suggesting maximum daily temperature doesn't matter as much for heat stress, instead long stretches of night time lows are more serious
