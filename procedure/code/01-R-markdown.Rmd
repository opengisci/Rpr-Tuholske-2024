...
The original study data transformations and analysis were completed primarily in R using Rmd documents, as well as python.
...
This includes: - Population data for the study period - Prison boundary polygons with facility information - State polygons - WBGT data, at prison point and state levels
