...
### (Attempt) Reproduce heat index

#### Convert Tmax and VPDmax from `.bil` to `.tif`

#### Create heat index

#### Convert heat index to WBGTmax

### Step 1: Process WBGT prison data

#### Create RDS of of WBGTmax daily for each year by prison

##### Join WBGTmax data to prison data

#### Prepare WBGT prison summary data
